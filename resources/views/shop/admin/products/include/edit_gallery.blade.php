<div class="card card-warning">
	...
	<div class="card-body">
		<div class="row" id="preview_gallery" style="text-align: left;">
			...
			<div class="col-sm-3 img" data-filename="{{ $gallery->img }}" data-id="{{ $gallery->id }}">
				<span class="close_pic" onclick="removeImage(this)">×</span>
				<a href="{{ asset('/uploads/gallery/') }}/{{ $gallery->img }}" data-lightbox="image-1">
					<img class="img-fluid" src="{{ asset('/uploads/gallery/') }}/{{ $gallery->img}}">
				</a>
			</div>
			@empty
			@endforelse
